const { insertForumData, getForumDataFromCollection, getForumDatabymail, addedCommnetById } = require("../lib/forum");
...
module.exports = { savedFrormPost, getForumPost, getForumPostbymail, postComment }